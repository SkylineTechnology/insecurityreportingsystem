...
$profile_id = isset($_GET["profile"]) ? base64_decode($_GET["profile"]) : "";


//here i am getting the user records
$rows = mysqli_fetch_array(mysqli_query($conn, "select * from residence where email='$profile_id'"));
$user_member_id = $rows["r_id"];
$user_fullname = $rows["fullname"];
$user_email = $rows["email"];
$user_gender = $rows["gender"];
$house_no = $rows["houseno"];
$user_area = $rows["area"];
                            ...
                            <div class="col-12 col-lg-5 col-xl-4">
                                ...
                                <div class="box box-inverse bg-img" style="background-image: url(../images/gallery/full/1.jpg);" data-overlay="2">
                                    ...
                                    <div class="box-body text-center pb-50">
                                        ...
                                        <span><i class="fa fa-map-marker w-20"></i> </span>
                                    </div>

                                    <ul class="box-body flexbox flex-justified text-center" data-overlay="4">
                                        <?php
                                        $num_of_my_post = mysqli_num_rows(mysqli_query($conn, "select * from complaints where r_id='$profile_id'"));
                                        $num_of_my_folowers = mysqli_num_rows(mysqli_query($conn, "select * from residence"));
                                        ?>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div>
                                                    ...
                                                    <p>House No: :<span class="text-gray pl-10"><?php echo $house_no; ?></span></p>
                                                    <p>Area :<span class="text-gray pl-10"><?php echo $user_area; ?></span></p>
                                                    <p>Phone :<span class="text-gray pl-10"><?php echo $user_phone; ?></span></p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row col-md-12">
                                                <div class="publisher publisher-multi col-md-12 bg-white b-1 mb-30">
                                                    <!--       <form method="post" action="" enctype="multipart/form-data">
                                                           <textarea readonly="" name="msg" class="publisher-input col-md-12 auto-expand" rows="4" placeholder="Write something"></textarea>
                                                           <div class="flexbox">
                                                               <div class="gap-items">
                                                               ...
                                                               <button readonly type="submit" name="add" class="btn btn-sm btn-bold btn-primary">Post</button>
                                                           </div>
                                                       </form> -->
                                                ...
                                                //Start Pagination 
                                                $item_per_page = 4;
                                                $number_of_items = mysqli_num_rows(mysqli_query($conn, "select * from complaints where r_id='$profile_id' order by date desc"));
                                                ...
                                                $get_post = mysqli_query($conn, "select * from complaints where r_id='$profile_id' order by date desc limit $current_page_first_item,$item_per_page");
                                                while ($row = mysqli_fetch_array($get_post)) {
                                                    ...
                                                    <div class="box">
                                                        ...
                                                        <form method="post" action="" class="publisher bt-1 border-fade">
                                                         ...
                                                         <input class="publisher-input" name="comment" readonly="" type="text" placeholder="Add Your Comment">
                                                            <input name="postid" type="hidden" value="<?php // echo $postid;  ?>">
                                                           <button type="submit" readonly="" class="btn btn-sm btn-bold btn-primary" name="addcomment"> <i class="fa fa-arrow-circle-up"></i></button>
                                                            -->
                                                        </form>
                                                            ...
                                                            <nav >
                                                                <ul class="pagination tab-content team-card border-radius-100 pagination pagination-lg">
                                                                    ...
                                                                    if ($nav > 1) {
                                                                        $prev = $nav - 1;
                                                                        ?>
                                                                        <li><a href="user-profile?profile=<?php echo base64_encode($profile_id) ?>&page=<?php echo $prev; ?>">&laquo; Previous</a></li>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                    <?php
                                                                    ...
                                                                    for ($page = 1; $page <= $number_of_pages; $page++) {
                                                                        ...
                                                                        ?>
                                                                        <li class="<?php echo $active; ?>"><a href="user-profile?profile=<?php echo base64_encode($profile_id) ?>&page=<?php echo $page; ?>"><?php echo $page; ?></a></li>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                    ...
                                                                    if ($number_of_pages > $nav) {
                                                                        $next = $nav + 1;
                                                                        ?>
                                                                        <li><a href="user-profile?profile=<?php echo base64_encode($profile_id) ?>&page=<?php echo $next; ?>">Next &raquo;</a></li>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </ul>
